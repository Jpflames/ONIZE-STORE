...
const OrdersComponent = ({ orders }: { orders: QueryResult }) => {
  const [isDeleting, setIsDeleting] = useState<string | null>(null);
  const [selectedOrder, setSelectedOrder] = useState<
    QueryResult[number] | null
  >(null);

  const handleOrderClick = (order: QueryResult[number]) => {
        ...
        <TooltipProvider>
          {orders.map((order) => (
            <Tooltip key={order?.orderNumber}>
                ...
                >
                  ...
                  <TableCell>
                    ...
                    <button
                      ...
                      className="ml-2 text-destructive hover:text-destructive/80 cursor-pointer transition-colors"
              ...
              <TooltipContent className="text-primary-foreground bg-primary font-medium">
