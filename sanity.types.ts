...
export type QueryResult = Array<{
  ...
  currency?: string;
  amountDiscount?: number;
  paymentStatus?: "cancelled" | "paid" | "pending";
  status?:
    | "complete"
    | "confirmed"
    | "delivered"
...
// Query: *[_type == 'order' && email == $email] | order(orderDate desc){    ...,products[]{      ...,product->    }  }
